...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens):
        ...
        if cfg.disentangled_position_encoder_layers is not None:
            if isinstance(cfg.disentangled_position_encoder_layers, str):
                cfg.disentangled_position_encoder_layers = utils.eval_str_list(
                    cfg.disentangled_position_encoder_layers, type=int
                )
            for i in cfg.disentangled_position_encoder_layers:
